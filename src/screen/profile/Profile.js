    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity onPress={() => pickImage(setBanner)} style={styles.bannerContainer}>
        ...
        <View style={styles.iconRow}>
          <TouchableOpacity onPress={() => navigation.navigate('EditProfile')}>
            <Icon name="create-outline" size={rf(2.5)} color="#fff" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Setting')}>
            <Icon name="settings-outline" size={rf(2.5)} color="#fff" />
          </TouchableOpacity>
        </View>
      </TouchableOpacity>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.lockIcon}>
          <Icon name="lock-closed" size={rf(2.5)} color= '#1e2e5a' />
        </View>
      </View>
  ...
  <View style={styles.redLine} />
        ...
        <View style={styles.resumeRow}>
          ...
          <TouchableOpacity style={styles.downloadBtn}>
            <Icon name="download-outline" size={rf(3.5)} color="#888" />
          </TouchableOpacity>
